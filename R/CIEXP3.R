...
#'@export
CIEXP3<-function(x1,x2,x3,alpha){
 ...
 # library(pracma)
  ...
  reliabumvue[1]<-(1-(1/(2*k)))-((1/k)*(part[2,1]+part[3,1] )       )
  reliabumvue[2]<-(1-(1/(2*k)))-((1/k)*(part[1,2]+part[3,2])        )
  reliabumvue[3]<-(1-(1/(2*k)))-((1/k)*(part[1,3]+part[2,3])        )
  ...
  reliabbayes[1]<-1-(1/(2*k))-(bayes(3,y[1],y[2],nsim[1],nsim[2])+bayes(3,y[1],y[3],nsim[1],nsim[3]))
  reliabbayes[2]<-1-(1/(2*k))-(bayes(3,y[2],y[1],nsim[2],nsim[1])+bayes(3,y[2],y[3],nsim[2],nsim[3]))
  reliabbayes[3]<-1-(1/(2*k))-(bayes(3,y[3],y[1],nsim[3],nsim[1])+bayes(3,y[3],y[2],nsim[3],nsim[2]))
...
#library(pracma)
    ...
    reliabumvue_boot[1]<-(1-(1/(2*k)))-((1/k)*(part_boot[2,1]+part_boot[3,1] )       )
    reliabumvue_boot[2]<-(1-(1/(2*k)))-((1/k)*(part_boot[1,2]+part_boot[3,2])        )
    reliabumvue_boot[3]<-(1-(1/(2*k)))-((1/k)*(part_boot[1,3]+part_boot[2,3])        )
    ...
    reliabbayes_boot[1]<-1-(1/(2*k))-(bayes(3,y_boot[1],y_boot[2],nsim[1],nsim[2])+bayes(3,y_boot[1],y_boot[3],nsim[1],nsim[3]))
    reliabbayes_boot[2]<-1-(1/(2*k))-(bayes(3,y_boot[2],y_boot[1],nsim[2],nsim[1])+bayes(3,y_boot[2],y_boot[3],nsim[2],nsim[3]))
    reliabbayes_boot[3]<-1-(1/(2*k))-(bayes(3,y_boot[3],y_boot[1],nsim[3],nsim[1])+bayes(3,y_boot[3],y_boot[2],nsim[3],nsim[2]))
  ...
  lb_mle<-c(C_star_mle1_1,C_star_mle1_2,C_star_mle1_3)
  ub_mle<-c(C_star_mle2_1,C_star_mle2_2,C_star_mle2_3)
  ...
  lb_umvue<-c(C_star_umvue1_1,C_star_umvue1_2,C_star_umvue1_3)
  ub_umvue<-c(C_star_umvue2_1,C_star_umvue2_2,C_star_umvue2_3)
  ...
  lb_bayes<-c(C_star_bayes1_1,C_star_bayes1_2,C_star_bayes1_3)
  ub_bayes<-c(C_star_bayes2_1,C_star_bayes2_2,C_star_bayes2_3)
  ...
  lb_bse<-c(C_star_bse1_1,C_star_bse1_2,C_star_bse1_3)
  ub_bse<-c(C_star_bse2_1,C_star_bse2_2,C_star_bse2_3)
